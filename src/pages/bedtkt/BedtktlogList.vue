<template>
    <div class="bedtktloglist fc-bg-gray">
        <div v-for="bedtktlog in bedtktloglist"  style="text-align: left; background:#fff;margin-top: 10px; padding: 10px 10px 10px 0px; box-sizing: border-box">
            <div>
                ...
                <span style="float: right; line-height: 2.2; color: #666">{{bedtktlog.lastlog_thedate}}</span>
            </div>
            <div style="padding: 10px 0px 10px 10px;line-height:1.8">
